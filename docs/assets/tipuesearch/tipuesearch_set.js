...
var tipuesearch_weight = {'weight': [
     {'url': '{{site.baseurl}}/architecture/*', 'score': 60},
     {'url': '{{site.baseurl}}/operations/*', 'score': 60},
     {'url': '{{site.baseurl}}/guide/*', 'score': 10},
     {'url': '{{site.baseurl}}/blog/*', 'score': 80}
]};
...
var tipuesearch_stem = {'words': [
     {'word': 'net app', 'stem': 'netapp'},
     {'word': 'netapp', 'stem': 'net app'},
     {'word': 'virtual', 'stem': 'vm'},
     {'word': 'vm', 'stem': 'virtual'},
     {'word': 'rados', 'stem': 'rgw'},
     {'word': 'rgw', 'stem': 'rados'},
     {'word': 'k8s', 'stem': 'kubernetes'},
     {'word': 'kubernetes', 'stem': 'k8s'},
